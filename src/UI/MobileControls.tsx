...
export default function MobileControls({ onOpenSettings }: MobileControlsProps) {
    ...
    return (
        ...
        <div className="fixed inset-0 z-[2000] pointer-events-none flex select-none touch-none block lg:hidden">
            ...
            <button
                ...
                className="absolute top-4 left-4 w-12 h-12 rounded-full bg-black/40 backdrop-blur-md border border-white/20 flex items-center justify-center text-white pointer-events-auto active:scale-95 transition-transform"
            >
            ...
            <button
                ...
                className={`absolute left-8 w-14 h-14 rounded-full flex items-center justify-center backdrop-blur-md border transition-all pointer-events-auto active:scale-95 ${isSpeaking
